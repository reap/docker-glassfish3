...
#
# Usage:
#   sh create_domain.sh [domain-name] [port-base]
#
...
$GLASSFISH_HOME/bin/asadmin --user admin --passwordfile glassfish.passwords create-domain --portbase ${PORT_BASE} ${DOMAIN_NAME}
